//1.2.3
let arr1 = [1, 5, 9, 4,
    obj = { name: "Viktoria", mark: 5, subject: "JS", },
...
//1.2.7
let arr2 = arr1.filter(element => typeof element === 'function');
...
//1.2.11
let arr3Reversed = arr3.reverse();

//1.2.12
arr3Reversed.forEach(element => {
    console.log(element);
});
...
//1.2.14
let filteredNumbers = arr1.filter(element => typeof element === 'number' && element > 4);
console.log("Елементи масиву arr1, значення яких більші за 4:", filteredNumbers);

//1.2.15
arr1[7](arr1[5]);

//1.2.16
console.log("Четвертий степіть числа -6:", arr1[6](-6));
